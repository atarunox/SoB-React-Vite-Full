...
const KO_STYLE = { background: 'linear-gradient(135deg, #1f0505 0%, #0d0202 80%, #110303 100%)' };
...
const WORLD_THEMES = {
  'Mines': {
    ...
    heroBg:       'border-stone-600',
    heroBgStyle:  { background: 'linear-gradient(135deg, #1e1509 0%, #130e06 50%, #0a0804 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Targa Plateau': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-cyan-900',
    heroBgStyle:  { background: 'linear-gradient(135deg, #0d1829 0%, #070f1d 50%, #030810 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Swamps of Jargono': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-green-700',
    heroBgStyle:  { background: 'linear-gradient(135deg, #081508 0%, #050e05 50%, #020602 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Derelict Ship': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-teal-800',
    heroBgStyle:  { background: 'linear-gradient(135deg, #0a1918 0%, #060f0f 50%, #020808 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Canyons': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-orange-800',
    heroBgStyle:  { background: 'linear-gradient(135deg, #1e0d02 0%, #130901 50%, #090502 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Blasted Wastes': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-yellow-800',
    heroBgStyle:  { background: 'linear-gradient(135deg, #1a1503 0%, #0f0e02 50%, #070601 100%)' },
    heroBgKO:     'border-red-700',
    heroBgKOStyle: KO_STYLE,
  ...
  'Frontier Town': {
    ...
    trackGD:      'bg-green-950 border-green-700 text-green-400',
    trackBS:      'bg-red-950  border-red-800  text-red-500',
    heroBg:       'border-leather',
    heroBgStyle:  { background: 'linear-gradient(135deg, #1e1409 0%, #130e05 50%, #0a0703 100%)' },
    heroBgKO:     'border-blood',
    heroBgKOStyle: KO_STYLE,
...
function HeroCard({ hero, theme }) {
  ...
  const cardBorderCls = isKO ? theme.heroBgKO     : theme.heroBg;
  const cardStyle     = isKO ? theme.heroBgKOStyle : theme.heroBgStyle;

  return (
    <div className={`rounded-2xl border p-4 md:p-5 space-y-3 ${cardBorderCls}`} style={cardStyle}>
      {/* Name + class row */}
