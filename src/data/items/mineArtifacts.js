export const mineArtifacts = [
  ...
  // --- Scanned batch -----------------------------------------------------------
  {
    ...
    darkStone: true,
    upgradeSlots: 0,
    effects: ['+1 Strength.', 'Your Combat Hits are +1 Damage.'],
    tags: ['Artifact', 'Dark Stone', 'Clothing', 'Gloves'],
  },
  {
    id: 'otherworld_artifact_cynder',
    name: 'Otherworld Artifact (Caverns of Cynder)',
    type: 'Artifact',
    slot: 'None',
    value: null,
  ...
  },
  {
    ...
    effects: [
      'Range 10, Shots 1.',
      'Uses the D8 for Damage. +1 Damage.',
      'You may take up to 3 Corruption Hits to add +1 Shot for each.',
      'While equipped, you also gain +2 Combat.',
    ],
    tags: ['Artifact', 'Gun', 'Rifle', 'Lost Army'],
  },
  {
    id: 'amulet_of_trondo',
    name: 'Amulet of Trondo',
  ...
  },
  {
    ...
    upgradeSlots: 0,
    effects: [
      'Use 2× Peril Die ({P}{P}) for Hold Back the Darkness tests.',
      'If doubles are rolled, you also take D6 Horror Hits and every other Hero takes 1 Horror Hit, as the Lantern\'s light shows you glimpses into the Void.',
    ],
    tags: ['Artifact', 'Light Source', 'Void'],
    restrictions: ['Limit one Light Source in the Hero Posse'],
    promoId: 'Promo-018',
  },
  {
    id: 'liquid_sunlight',
    ...
    upgradeSlots: 0,
    effects: [
      'Discard to immediately do D3 Wounds, ignoring Defense, Armor, and Endurance, to every Undead model on the same and adjacent Map Tiles to you.',
      'OR Discard to Re-roll a Hold Back the Darkness roll just rolled.',
    ],
    tags: ['Artifact', 'Glass', 'Light'],
  },
  {
    id: 'moles_foot_amulet',
    name: "Mole's Foot Amulet",
    type: 'Artifact',
    slot: 'Extra 1',
    value: 350,
  ...
  },
  {
    ...
    upgradeSlots: 0,
    effects: [
      'Discard for the following Free Attack: Range 12, Shots 2. Any Hits count as Critical Hits.',
    ],
    tags: ['Artifact', 'Void', 'Scroll', 'Magik'],
  },
  {
  ...
  },
  {
    ...
    weight: 1,
    upgradeSlots: 0,
    effects: ['Once per Adventure, you may add or subtract 1 from a single one of your Dice Rolls.'],
    tags: ['Artifact', 'Charm'],
  },
  {
    id: 'angels_tears',
  ...
  },
  {
    ...
    upgradeSlots: 0,
    effects: [
      'You may focus the light of the Lantern through the Dark Stone Prism.',
      'Free Attack (Once per Fight) — While in the same or adjacent space as the Lantern, use 1 Grit to count out a straight line beam from your space a number of spaces equal to the Hold Back the Darkness roll this turn. Any model in a space the beam passes into takes D3 Wounds, ignoring Defense.',
    ],
    tags: ['Artifact', 'Dark Stone'],
  },
  {
    id: 'otherworld_artifact_derelict',
    name: 'Otherworld Artifact (Derelict Ship)',
    type: 'Artifact',
    slot: 'None',
    value: null,
  ...
  },
  {
    ...
    darkStone: false,
    upgradeSlots: 0,
    effects: ['Range 6, Shots 3.', '+1 Damage to Undead.'],
    tags: ['Artifact', 'Gun', 'Pistol', 'Occult'],
  },
  {
    id: 'book_of_the_mad_king',
    name: 'Book of the Mad King',
    type: 'Artifact',
    slot: 'Extra 1',
    value: 725,
    ...
    upgradeSlots: 0,
    effects: [
      'Once per Fight, you may read from the book. Choose an Enemy on your Map Tile to take D6 Wounds with no Defense.',
      'You then take either D6 Corruption Hits or 2D6 Horror Hits (you choose).',
    ],
    tags: ['Artifact', 'Book', 'Occult'],
  },
  ...
  { id: 'mine_brace_of_dark_stone_pistols_2', name: "Brace of Dark Stone Pistols", type: "Artifact - Gun - Pistol - Dark Stone", slot: "Hand Weapon", value: 1250, twoHanded: true, weight: 1, darkStone: 2, upgradeSlots: 1, effects: ["Range 6; Shots 4.", "Uses the Peril Die for Damage.", "Frontier or Outlaw Only."], tags: ["Artifact", "Gun", "Pistol", "Dark Stone", "Frontier/Outlaw Only"] },
